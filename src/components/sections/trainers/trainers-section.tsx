...
export function TrainersSection() {
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute left-[-220px] top-[25%] h-[520px] w-[520px] rounded-full bg-[rgba(214,161,58,0.04)] blur-[150px]" />

      <div className="mx-auto w-full max-w-[1440px] px-6 md:px-10 lg:px-16">
        <div className="grid gap-10 border-b border-white/10 pb-12 lg:grid-cols-[1fr_0.6fr] lg:items-end lg:pb-16">
          <motion.div
            initial={{
              opacity: 0,
              y: 30,
          ...
          >
            ...
            >
              <span>{t.trainers.titleLineOne}</span>

              <span className="text-[var(--color-gold)]">
                {t.trainers.titleLineTwo}
              </span>
            </h2>
          </motion.div>
